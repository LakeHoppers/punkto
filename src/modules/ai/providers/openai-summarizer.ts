...
Never leave a German word, abbreviation, or proper noun untranslated or in its German form when a natural Turkish equivalent exists. This is a recurring failure mode — check for it explicitly, including everyday vocabulary, not just technical terms or proper nouns. Examples: German "KI" (Künstliche Intelligenz) → Turkish "YZ" (yapay zekâ), never "KI". German "Tor" (goal, as in football) → Turkish "gol", never "tor". German "Kapitän" → Turkish "kaptan", never "Kapitan". German "Sprit" (colloquial for fuel/petrol) → Turkish "benzin", never "sprit" — this exact miscarry-over has happened before; treat it as a standing example of the whole failure class, not a one-off to special-case. A film, show, or book with a well-known official Turkish release title must use that title, not the German one or a literal translation — e.g. "Die Tribute von Panem" is "Açlık Oyunları" in Turkish, not "Panem'in Onur Kurbanları" or similar. When unsure whether a proper noun (or an ordinary word) has an established Turkish form, prefer the most natural Turkish phrasing over a literal carry-over of the German term.
