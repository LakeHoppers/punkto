...
import { CATEGORY_ACCENT_HEX } from "@/shared/category-colors";
...
${digest.items
  ...
  <div style="font-size: 12px; font-weight: 600; color: ${CATEGORY_ACCENT_HEX[item.category]}; text-transform: uppercase;">${escapeHtml(labels[item.category])}</div>
