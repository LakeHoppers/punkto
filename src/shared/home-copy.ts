...
> = {
  tr: {
    ...
    description:
      "Punkto; en önemli Alman haberlerini toplar, tekrarları ayıklar, önem sırasına koyar ve akıcı Türkçe özetler halinde neden önemli olduğunu anlatır. Almanya, özetle.",
  ...
  de: {
    ...
    description: "Punkto sammelt die wichtigsten Nachrichten aus Deutschland, entfernt Dopplungen, ordnet sie nach Bedeutung und erklärt in einer täglichen Zusammenfassung, warum sie wichtig sind. Deutschland, auf den Punkt.",
  ...
  en: {
    ...
    description:
      "Punkto collects the most important German news, removes duplicates, ranks them by importance, and explains why each one matters in a fluent daily summary. Germany, to the point.",
